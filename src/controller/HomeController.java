...
public class HomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        lblUserName.setText(user.getUserName() + " (Editor)");
    ...
    private void homeOnAction(ActionEvent event) {
        ...
        stage.setTitle("Home - IT In the Valley Information System");
        try {
            mainContent.getChildren().clear();
            mainContent.getChildren().add(FXMLLoader.load(getClass().getResource("/view/HomeContent.fxml")));
            homeActive();
    ...
    private void prescriptionOnAction(ActionEvent event) {
        Stage stage = (Stage) btnSetting.getScene().getWindow();
        stage.setTitle("Magazine Issue");
        try {
            mainContent.getChildren().clear();
            mainContent.getChildren().add(FXMLLoader.load(getClass().getResource("/view/issue/Issue.fxml")));
            prescriptionActive();
        } catch (IOException ex) {
            Logger.getLogger(HomeController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void patientOnAction(ActionEvent event) {
        ...
        try {
            mainContent.getChildren().clear();
            mainContent.getChildren().add(FXMLLoader.load(getClass().getResource("/view/magazine/Magazine.fxml")));
            patientActive();
        } catch (IOException ex) {
            Logger.getLogger(HomeController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void drugOnAction(ActionEvent event) {
        Stage stage = (Stage) btnSetting.getScene().getWindow();
        stage.setTitle("Adverts/Media");
        try {
            mainContent.getChildren().clear();
            mainContent.getChildren().add(FXMLLoader.load(getClass().getResource("/view/ads/Ads.fxml")));
            drugActive();
        } catch (IOException ex) {
            Logger.getLogger(HomeController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void handleBuyButton(ActionEvent event) throws IOException {
        Desktop.getDesktop().browse(URI.create("https://uwl.co.uk"));
    }
    ...
    private void handleFeedBack(ActionEvent event) {
        ...
        alert.setHeaderText("I like to hear your feedback, email me at: 213213@uwl.ac.uk");
        alert.showAndWait();
    }
