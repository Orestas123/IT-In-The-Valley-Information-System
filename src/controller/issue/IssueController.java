...
import view.issue.MagazineCardIssue;
...
public class IssueController implements Initializable {
    ...
    private void newPrescriptionOnAction(ActionEvent event) throws IOException {
        ...
        stage.setTitle("Select Magazine to Issue");
        stage.show();
    }
    ...
    private void deletePrescription(Prescription prescription) {
        if (prescriptionGetway.deletePrescription(prescription)) {
            ...
            alert.setHeaderText("Magazine has been deleted");
            alert.setContentText("Magazine has been deleted successfully");
            alert.show();
            if (prescriptionDefault) {
                loadPrescriptions();
            } else {
        ...
        final TableCell<Prescription, String> cell = new TableCell<Prescription, String>() {
            ...
            public void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    MagazineCardIssue base = new MagazineCardIssue(patient) {
                    };
                    setGraphic(base);
                    setText(null);
                }
            ...
            public void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    button.setOnAction((ActionEvent event) -> {
                        ...
                        System.out.println("Click : Magazine ID : " + getTableView().getItems().get(getIndex()).getId());
                    });
                    delete.setOnAction((ActionEvent event) -> {
                        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                        alert.setTitle("Confirm");
                        alert.setHeaderText("You want to delete this page ?");
