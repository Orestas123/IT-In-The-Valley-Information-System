...
public class ViewIssueController implements Initializable {
    ...
    public void loadPrescription(int prescriptionId) {
        ...
        lblPatientName.setText("Magazine Name : " + prescription.getPatientName());
        lblDate.setText("Issue Date : " + prescription.getDate());
        try {
            file = new File("Issue.html");
            file.createNewFile();
...
//            Desktop.getDesktop().browse(URI.create("issue.html"));
