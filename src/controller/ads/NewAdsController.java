 ...
 */
public class NewAdsController implements Initializable {
    ...
    private void saveDrugOnAction(ActionEvent event) {
        if (isVliadForm()) {
            ...
            if (drugGetway.save(drug)) {
                System.out.println("Advert id : " +drug.getId());
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Advert saved");
                alert.setHeaderText("Advert Saved ");
                alert.showAndWait();
                resetForm();
            }
        }
