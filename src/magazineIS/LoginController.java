...
public class LoginController implements Initializable {
        ...
        if (isValid()) {
            if (auth.authenticate(tfUserName.getText(), pfPassword.getText())) {
                try {
                    ...
                    stage.setTitle("IT In The Valley - Information System - Home");
                ...
                alert.setTitle("Username or password mismatched");
    ...
    private void hlForgetPassword(ActionEvent event) {
        try {
            ...
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            stage.setTitle("IT In The Valley - Information System - Forget Password");
            stage.setScene(scene);
