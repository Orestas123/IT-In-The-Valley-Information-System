...
public abstract class MagazineCard extends AnchorPane {
    ...
    public MagazineCard(Patient patient) {
        ...
        label0.setText("Duration : " + age(patient) + " Days");

        patientSex = patient.getSex() == 1 ? "Cyber Security" : patient.getSex() == 2 ? "IT-Tech" : "Other";

        label1.setText("Type : " + patientSex);
        label2.setText("Started from : " + patient.getCreatedAt());
        label3.setText("No. of Ads/Media : " + patient.getNumberOfPrescription());
